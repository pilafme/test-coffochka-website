...
**Статус:** ❌ Failed  
**Комментарий:** "Чай Улун Молочный 100 г" отсутствующий в ассортименте можно найти через фильтры и поисковой запрос, чтобы сделать более информативный поиск необходимо добавить фильтр по наличию товара.
...
**ОР:** Доступен выбор степени помола только для кофе  
**ФР:** Помол можно выбрать для любого продукта
**Статус:** ❌ Failed   
**Комментарий:** Помол можно выбрать и для дрип-пакетов и кофейника.
...
**Статус:** ❌ Failed   
**Комментарий:** В контакты необходимо добавить электронную почту, ссылку на профиль в сети Instagram, адрес пункта самовывоза.
...
**Статус:** ❌ Failed  
**Комментарий:** В футер необходимо добавить адрес пункта самовывоза, ссылку на Whatsapp и электронную почту, а так же их иконки
...
**ФР:** Данные соответствуют действительности  
**Статус:** ❌ Failed  
**Комментарий:** Все предложения по улучшению переводов и описаний представлены в папке https://github.com/pilafme/test-coffochka-website/tree/main/corrections
...
**Статус:** ❌ Failed 
**Комментарий:** В армянской версии в шапке сайта «О компании» написано на английском "About company"
...
**Статус:** ❌ Failed 
**Комментарий:** При регистрации на русском и армянском языках отображаются подсказки на английском "Please input your User name!" и "Please input your email!".
