...
## 10. Ресурсы и роли (Resources and Roles)

- Тестировщик — отвечает за планирование, выполнение тестов, оформление баг-репортов и коммуникацию с командой.  
- Разработчик — отвечает за исправление дефектов, консультации по техническим вопросам и поддержку тестировщика.  

## 11. Расписание и сроки (Schedule and Timeline)

- Старт тестирования: 27.07.2025  
- Продолжительность тестирования: 14 дней  
- Предоставление итогового отчёта: 10.08.2025  

## 12. Отчётность и метрики (Reporting and Metrics)

- Все найденные дефекты фиксируются в Jira с указанием приоритета и статуса.  
- Выполняется еженедельное обновление статуса тестирования.  
- По завершении тестирования формируется итоговый отчёт с анализом и рекомендациями.  

## 13. Коммуникация (Communication)

- Основной канал связи: Telegram  
- Регулярные встречи/созвоны: раз в неделю  
- Контактные лица для быстрого решения вопросов:  
  - Тестировщик: @pilafme  
  - Разработчик: @coffochka.test  
